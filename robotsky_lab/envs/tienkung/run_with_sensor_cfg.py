...
from robotsky_lab.assets.tienkung2_lite import TIENKUNG2LITE_CFG
from robotsky_lab.envs.base.base_config import (
    ActionDelayCfg,
    BaseSceneCfg,
    CommandRangesCfg,
    CommandsCfg,
...
from robotsky_lab.sensors.camera.camera_cfgs import TiledD455CameraCfg
from robotsky_lab.sensors.lidar.lidat_cfg import LidarCfg
from robotsky_lab.terrains import GRAVEL_TERRAINS_CFG, ROUGH_TERRAINS_CFG  # noqa:F401
...
class TienKungRunWithSensorFlatEnvCfg:
    amp_motion_files_display = ["robotsky_lab/envs/tienkung/datasets/motion_visualization/run.txt"]
    device: str = "cuda:0"
...
class TienKungRunWithSensorAgentCfg(RslRlOnPolicyRunnerCfg):
    ...
    # amp parameter
    amp_reward_coef = 0.3
    amp_motion_files = ["robotsky_lab/envs/tienkung/datasets/motion_amp_expert/run.txt"]

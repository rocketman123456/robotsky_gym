...
from robotsky_lab.sensors.lidar import LidarCfg
...
class TienKungWalkWithSensorFlatEnvCfg:
    amp_motion_files_display = ["robotsky_lab/envs/tienkung/datasets/motion_visualization/walk.txt"]
    device: str = "cuda:0"
...
class TienKungWalkWithSensorAgentCfg(RslRlOnPolicyRunnerCfg):
    ...
    # amp parameter
    amp_reward_coef = 0.3
    amp_motion_files = ["robotsky_lab/envs/tienkung/datasets/motion_amp_expert/walk.txt"]

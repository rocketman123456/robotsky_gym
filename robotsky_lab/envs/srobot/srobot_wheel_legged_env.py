...
from robotsky_lab.envs.srobot.srobot_wheel_legged_config import SrobotWheelLeggedFlatEnvCfg, SrobotWheelLeggedRoughEnvCfg
import torch


class SrobotWheelLeggedEnv(BaseEnv):
    def __init__(self, cfg: SrobotWheelLeggedFlatEnvCfg | SrobotWheelLeggedRoughEnvCfg, hedless):
        self.cfg: SrobotWheelLeggedFlatEnvCfg | SrobotWheelLeggedRoughEnvCfg

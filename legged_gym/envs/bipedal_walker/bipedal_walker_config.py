...
class BipedalWalkerCfg(LeggedRobotCfg):
    ...
    class init_state(LeggedRobotCfg.init_state):
        ...
        default_joint_angles = {  # = target angles [rad] when action = 0.0
            "hip_joint_saggital_right": -0.0,  # -0
            "hip_joint_frontal_right": 0.0,
            "hip_joint_transversal_right": 0.0,
            "knee_joint_right": -0.0,
            "ankle_joint_right": 0.0,
            "hip_joint_saggital_left": -0.0,
            "hip_joint_frontal_left": 0.0,
            "hip_joint_transversal_left": 0.0,
            "knee_joint_left": -0.0,
    ...
    class control(LeggedRobotCfg.control):
        ...
        # control_type = 'P'
        stiffness = {
            "hip_joint_saggital": 100.0,
            "hip_joint_frontal": 100.0,
            "hip_joint_transversal": 200.0,
            "knee_joint": 200.0,
            "ankle_joint": 200.0,
        }  # [N*m/rad]
        damping = {
            "hip_joint_saggital": 3.0,
            "hip_joint_frontal": 3.0,
            "hip_joint_transversal": 6.0,
            "knee_joint": 6.0,
            "ankle_joint": 10.0,
        }  # [N*m*s/rad]

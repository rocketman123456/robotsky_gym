...
def plot_stability(
    body_height, body_raw, body_pitch, env_names=None, title=None, dt=1.0, xlabel_fontsize=12, ylabel_fontsize=12, title_fontsize=14, save_path=None
):
...
def visualize_legged_robot_contacts(
    contacts, args=["LF", "RF", "LR", "RR"], xlim=None, title=None, title_fontsize=12, dt=0.02, xlabel_fontsize=10, save_path=None, filter_window_size=None
):
...
def plot_3d_points(
    ...
    marker_color="blue",
    other_marker="o",
    other_marker_size=50,
    other_marker_color="red",
    xlim=None,
    ylim=None,
    zlim=None,
    viewpoint=(30, 15),
    ...
    if other_points is not None:
        ...
        ax.scatter(other_x, other_y, other_z, marker=other_marker, s=other_marker_size, c=other_marker_color, label="PF Points")
...
def plot_multiple_datasets_dual_yaxis(
    data_list,
    data_names,
    x_name,
    xlim,
    ...
    custom_legend_items.append(Line2D([0], [0], color=color, linestyle="dashed", lw=2, label=f"{type_name}"))
    # 添加图例

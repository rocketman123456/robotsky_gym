...
class Terrain:
    ...
    def randomized_terrain(self):
        for k in range(self.num_sub_terrains):
            ...
            difficulty = np.random.choice([0.2, 0.4, 0.6])
            # difficulty = 0.0
    ...
    def curiculum(self):
        for j in range(self.cfg.num_cols):
            for i in range(self.cfg.num_rows):
                difficulty = i / self.cfg.num_rows * 0.75  # reduce terrain difficulty
...
class WheeledQuadTerrain(Terrain):
    def __init__(self, cfg: LeggedRobotCfg.terrain, num_robots) -> None:
    ...
    def make_terrain(self, choice, difficulty):
        ...
        slope = difficulty * 0.4
        step_height = 0.05 + 0.10 * difficulty
        discrete_obstacles_height = 0.05 + difficulty * 0.2
        stepping_stones_size = 1.5 * (1.05 - difficulty)
        stone_distance = 0.05 if difficulty == 0 else 0.1
        gap_size = 1.0 * difficulty

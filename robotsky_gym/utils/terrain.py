...
from robotsky_gym.utils import terrain_utils
from robotsky_gym.envs.base.legged_robot_config import LeggedRobotCfg
...
class Terrain:
    ...
    def make_terrain(self, choice, difficulty):
        ...
        if choice < self.proportions[0]:
            ...
            terrain_utils.stepping_stones_terrain(terrain, stone_size=stepping_stones_size, stone_distance=stone_distance, max_height=0.0, platform_size=4.0)

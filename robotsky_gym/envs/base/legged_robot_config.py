...
class LeggedRobotCfg(BaseConfig):
    class env:
        ...
        num_privileged_obs = (
            None  # if not None a priviledge_obs_buf will be returned by step() (critic obs for assymetric training). None is returned otherwise
        )
        num_actions = 12
    ...
    class init_state:
        ...
        dof_names = None  # please define the names of the dofs,and the order of the action will align with the order of the names
        # initial state randomization
        base_ang_random_scale = 0.0
    ...
    class asset:
        ...
        max_joint_velocity = {"hip": 52.4, "thigh": 28.6, "calf": 28.6}  # [rad/s]
    ...
    class normalization:
        ...
        clip_observations = 37.0  # 100.0
        clip_actions = 5.0  # 100.0
